...
export default function SocialScreen() {
  ...
  return (
    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: C.darkBg, padding: 24 }}>
      ...
      <Text style={{ fontSize: 26, fontWeight: '900', color: C.gold, letterSpacing: 1 }}>Poop Squad</Text>
      <Text style={{ fontSize: 15, color: C.textSecondary, marginTop: 6 }}>Compare thrones with friends</Text>
      <View style={{
        marginTop: 24,
